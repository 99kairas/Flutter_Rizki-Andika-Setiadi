...
void main() {
  runApp(MultiProvider(
    providers: [
      ...
      ChangeNotifierProvider<ListContactViewModel>(
          create: (_) => ListContactViewModel()),
      ChangeNotifierProvider<ListFoodViewModel>(
          create: (_) => ListFoodViewModel()),
    ],
    child: const MyApp(),
  ));
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/contacts-api': (context) => const ContactsWithApiPage(),
      },
